...
/**
 * Holds the Stream related details transferred to Gateway.
 */

public class StreamEvent extends GatewayEvent{
    ...
    public void setStreamSummary(StreamSummary streamSummary) {
